...
public class CmmUseDAO extends EgovComAbstractDAO {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<CmmnDetailCode> selectChurchInfoDetail(ComDefaultCodeVO vo) throws Exception {
	return (List<CmmnDetailCode>) list("CmmUseDAO.selectChurchInfoDetail", vo);
    }
}
