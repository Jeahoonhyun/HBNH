package hbnh.let.uss.umt.service.impl;
...
public class EgovUserManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserManageService {
	...
	public void updateUser(UserManageVO userManageVO) throws Exception {
		//패스워드 암호화
		if(userManageVO.getPassword() != null && !"".equals(userManageVO.getPassword())){
			String password = EgovFileScrty.encryptPassword(userManageVO.getPassword(), userManageVO.getEmplyrId());
	...
	@Override
	public UserManageVO selectUserInfoFind(UserManageVO userManageVO)
			throws Exception {
		// TODO Auto-generated method stub
		return userManageDAO.selectUserInfoFind(userManageVO);
	}
