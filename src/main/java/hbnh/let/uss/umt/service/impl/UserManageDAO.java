...
public class UserManageDAO extends EgovAbstractDAO{
    ...
    public int checkIdDplct(String checkId){
        return (Integer)selectByPk("userManageDAO.checkIdDplct_S", checkId);
    }
    ...
    public int selectUserListTotCnt(UserDefaultVO userSearchVO) {
        return (Integer)selectByPk("userManageDAO.selectUserListTotCnt_S", userSearchVO);
    }
    ...
    public UserManageVO selectUserInfoFind(UserManageVO userManageVO){
    	return (UserManageVO)selectByPk("userManageDAO.selectUserInfoFind", userManageVO);
    }
