...
public class BBSUseInfoManageDAO extends EgovAbstractDAO {
	...
	return (Integer)selectByPk("BBSUseInfoManageDAO.selectBBSUseInfsCnt", bdUseVO);
    }
	...
	return (Integer)selectByPk("BBSUseInfoManageDAO.selectBBSUseInfsCntByTrget", bdUseVO);
    }
