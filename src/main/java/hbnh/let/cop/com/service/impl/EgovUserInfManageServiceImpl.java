...
public class EgovUserInfManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserInfManageService {
     ...
     * 동호회 운영자 목록을 조회한다.
     * 
     * @see hbnh.let.cop.com.service.EgovUserInfManageService#selectClubOprtrList(hbnh.let.cop.com.service.UserInfVO)
     */
     ...
     * 동호회 사용자 목록을 조회한다.
     * 
     * @see hbnh.let.cop.com.service.EgovUserInfManageService#selectClubUserList(hbnh.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 관리자 목록을 조회한다.
     * 
     * @see hbnh.let.cop.com.service.EgovUserInfManageService#selectCmmntyMngrList(hbnh.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 사용자 목록을 조회한다.
     * 
     * @see hbnh.let.cop.com.service.EgovUserInfManageService#selectCmmntyUserList(hbnh.let.cop.com.service.UserInfVO)
     */
     ...
     * 사용자 정보에 대한 목록을 조회한다.
     * 
     * @see hbnh.let.cop.com.service.EgovUserInfManageService#selectUserList(hbnh.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see hbnh.let.cop.com.service.EgovUserInfManageService#selectAllClubUser(hbnh.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see hbnh.let.cop.com.service.EgovUserInfManageService#selectAllCmmntyUser(hbnh.let.cop.com.service.UserInfVO)
     */
