package hbnh.let.cop.com.service.impl;
...
import hbnh.let.cop.com.service.BoardUseInf;
import hbnh.let.cop.com.service.BoardUseInfVO;
import hbnh.let.cop.com.service.EgovBBSUseInfoManageService;
...
public class EgovBBSUseInfoManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSUseInfoManageService {
     ...
     * 게시판 사용 정보를 삭제한다.
     * 
     * @see hbnh.let.cop.bbs.com.service.EgovBBSUseInfoManageService#deleteBBSUseInf(hbnh.let.cop.bbs.com.service.BoardUseInf)
     */
     ...
     * 게시판 사용정보를 등록한다.
     * 
     * @see hbnh.let.cop.bbs.com.service.EgovBBSUseInfoManageService#insertBBSUseInf(hbnh.let.cop.bbs.com.service.BoardUseInf)
     */
     ...
     * 게시판 사용정보 목록을 조회한다.
     * 
     * @see hbnh.let.cop.bbs.com.service.EgovBBSUseInfoManageService#selectBBSUseInfs(hbnh.let.cop.bbs.com.service.BoardUseInfVO)
     */
     ...
     * 게시판 사용정보를 수정한다.
     * 
     * @see hbnh.let.cop.bbs.com.service.EgovBBSUseInfoManageService#updateBBSUseInf(hbnh.let.cop.bbs.com.service.BoardUseInf)
     */
     ...
     * 
     * @see hbnh.let.cop.bbs.com.service.EgovBBSUseInfoManageService#selectBBSUseInf(hbnh.let.cop.bbs.com.service.BoardUseInfVO)
     */
     ...
     * 
     * @see hbnh.let.cop.com.service.EgovBBSUseInfoManageService#deleteBBSUseInfByClub(hbnh.let.cop.com.service.BoardUseInf)
     */
     ...
     * 
     * @see hbnh.let.cop.com.service.EgovBBSUseInfoManageService#deleteBBSUseInfByCmmnty(hbnh.let.cop.com.service.BoardUseInf)
     */
     ...
     * 
     * @see hbnh.let.cop.com.service.EgovBBSUseInfoManageService#deleteAllBBSUseInfByClub(hbnh.let.cop.com.service.BoardUseInfVO)
     */
     ...
     * 
     * @see hbnh.let.cop.com.service.EgovBBSUseInfoManageService#deleteAllBBSUseInfByCmmnty(hbnh.let.cop.com.service.BoardUseInfVO)
     */
     ...
     * 게시판에 대한 사용정보를 삭제한다.
     * 
     * @see hbnh.let.cop.com.service.EgovBBSUseInfoManageService#deleteBBSUseInfByBoardId(hbnh.let.cop.com.service.BoardUseInf)
     */
     ...
     * 
     * @see hbnh.let.cop.com.service.EgovBBSUseInfoManageService#selectBBSUseInfsByTrget(hbnh.let.cop.com.service.BoardUseInfVO)
     */
