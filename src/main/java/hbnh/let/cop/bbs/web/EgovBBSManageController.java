...
import hbnh.com.cmm.service.EgovFileMngUtil;
import hbnh.com.cmm.service.FileVO;
import hbnh.com.cmm.util.EgovUserDetailsHelper;
...
public class EgovBBSManageController {
    ...
    public String selectBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "cop/bbs/hbnhNoticeInqire";
    }
	...
	return "cop/bbs/hbnhNoticeRegist";
    }
