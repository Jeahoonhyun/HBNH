...
public class BBSAttributeManageDAO extends EgovAbstractDAO {
	...
	return (Integer)selectByPk("BBSAttributeManageDAO.selectBBSMasterInfsCnt", vo);
    }
	...
	return (Integer)selectByPk("BBSAttributeManageDAO.selectBdMstrListCntByTrget", vo);
    }
	...
	return (Integer)selectByPk("BBSAttributeManageDAO.selectNotUsedBdMstrListCnt", vo);
    }
}
