...
import hbnh.let.cop.bbs.service.Board;
import hbnh.let.cop.bbs.service.BoardVO;
import hbnh.let.cop.bbs.service.EgovBBSManageService;
...
public class EgovBBSManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSManageService {
     ...
     * 게시물 한 건을 삭제 한다.
     *
     * @see hbnh.let.cop.bbs.brd.service.EgovBBSManageService#deleteBoardArticle(hbnh.let.cop.bbs.brd.service.Board)
     */
     ...
     *
     * @see hbnh.let.cop.bbs.brd.service.EgovBBSManageService#insertBoardArticle(hbnh.let.cop.bbs.brd.service.Board)
     */
     ...
     *
     * @see hbnh.let.cop.bbs.brd.service.EgovBBSManageService#selectBoardArticle(hbnh.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     *
     * @see hbnh.let.cop.bbs.brd.service.EgovBBSManageService#selectBoardArticles(hbnh.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 게시물 한 건의 내용을 수정 한다.
     *
     * @see hbnh.let.cop.bbs.brd.service.EgovBBSManageService#updateBoardArticle(hbnh.let.cop.bbs.brd.service.Board)
     */
     ...
     * 방명록 내용을 삭제 한다.
     *
     * @see hbnh.let.cop.bbs.brd.service.EgovBBSManageService#deleteGuestList(hbnh.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 방명록에 대한 목록을 조회 한다.
     *
     * @see hbnh.let.cop.bbs.brd.service.EgovBBSManageService#selectGuestList(hbnh.let.cop.bbs.brd.service.BoardVO)
     */
