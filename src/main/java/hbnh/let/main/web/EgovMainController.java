...
public class EgovMainController {
	...
	public String getMgtMainPage(HttpServletRequest request, ModelMap model)
	  throws Exception{
		...
		fileVO.setBbsId("BBSMSTR_000000000020");		
		model.addAttribute("galList", fileService.selectMainImageFileDetail(fileVO));

		// 공지사항 메인컨텐츠 조회 끝 -----------------------------------

		//return "main/EgovMainView";
		return "main/hbnhMainView";
	}
     ...
     * @exception Exception
     */
    @RequestMapping(value="/sym/mms/HbnhIncHeader.do")
    public String HbnhIncHeader(
    		@ModelAttribute("menuManageVO") MenuManageVO menuManageVO,
    		ModelMap model)
            throws Exception {

    	
    	return "main/inc/hbnhIncHeader";
    }
    
    @RequestMapping(value="/sym/mms/EgovSubMenuHead.do")
    public String selectSubMenuHead(
    		@ModelAttribute("menuManageVO") MenuManageVO menuManageVO,
    		ModelMap model)
            throws Exception {
    	...
    	return "main/inc/hbnhIncTopnavSub";
    }
    
    /**
     * Main Top Navigation 메뉴를 조회한다.
     * @param menuManageVO MenuManageVO
     * @return 출력페이지정보 "main_headG", "main_head"
     * @exception Exception
     */
    @RequestMapping(value="/sym/mms/HbnhIncTopnav.do")
    public String hbnhIncTopnav(
    		@ModelAttribute("menuManageVO") MenuManageVO menuManageVO,
    		ModelMap model)
            throws Exception {
