<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="hbnh.let.utl.sms.service.ApiClass" %>
<%@ page import="hbnh.let.utl.sms.service.ApiResult" %>
...
String api_id = "owthit";		// sms.gabia.com 이용 ID
String api_key = "df42fe793b920d3a8080a37b50667a4b";	// 환결설정에서 확인 가능한 SMS API KEY
...
arr[1] = "test0001";				// 결과 확인을 위한 KEY ( 중복되지 않도록 생성하여 전달해 주시기 바랍니다. )
arr[2] = "함북노회문자테스트0001";							//  LMS 발송시 제목으로 사용 SMS 발송시는 수신자에게 내용이 보이지 않음.
arr[3] = "안녕하세요.함북노회입니다.문자발송테스트입니다.감사합니다.";					// 본문 (90byte 제한)
arr[4] = "01027025037";			// 발신 번호
arr[5] = "01027025037";				// 수신 번호
