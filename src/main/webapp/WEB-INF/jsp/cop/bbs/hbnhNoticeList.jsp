        ...
        <div class="content_box">
            ...
            <div class="content">
            	...
            	<div class="srch_box">
                    ...
                    <input name="searchWrd" type="text"  value='<c:out value="${searchVO.searchWrd}"/>' onkeypress="press(event);" title="검색어 입력">
                    <input type="button" value="검색" onclick="javascript:fn_egov_select_noticeList('1'); return false;">
              	</div>
              	</form>
