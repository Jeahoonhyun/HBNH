    ...
    <div class="content_wrap">
        ...
        <div class="content_box">
            ...
            <div class="mem_box">
                <div class="mem_list">
                  <table>
                  	<caption style="text-align:right;">목(목사), 부(부목사), 장(장로) [2019.02.20 기준]</caption>
                  	<colgroup>
                    ...
                    <tr>
                      ...
                      <td align="center">목</td>                      
                      <td>박한용(예꿈)<br>이재현(청아)<br>박성일(베다니장로)</td>
                      <td>최국렬(평택삼락)</td>
                      <td>김영범(강서선한목자)<br>정헌남(삶이기쁜)</td>
                    </tr>                    
                    <tr>
                      <td align="center">장</td>                      
                      <td>하재옥(동광)</td>
                    ...
                    <tr>
                      ...
                      <td align="center">목</td>                      
                      <td>현윤식(경배와찬양)<br>김정석(푸른나무)<br>강철훈(한세)<br>이상은(서광)</td>
                    ...
                    <tr>
                      ...
                      <td>정경주(삼일)<br>전명수(은석)<br>조동진(예원)</td>
                      <td>안민호(동광)<br>황준(경배와찬양)</td>
                      <td>김정민(동광)<br>송수영(선한목자)</td>
                    </tr>                    
                    <tr>
                      ...
                      <td>정은용(축복)<br>이학명(평강)<br>김상호(솔샘)<br>김경호(울산새벽)</td>
                      <td>이경열(동광)<br>이병희(청심)<br>문건호(군산사랑)</td>
                    </tr>
                    <tr>
                      <td align="center">부</td>                      
                      <td>김기탁(삼일)<br>신현수(인천임마누엘)<br>윤요한(수유중앙)</td>
                      <td>허평석(은혜)<br>정신광(인천임마누엘)<br>김진우(은혜)</td>
                    ...
                    <tr>
                      ...
                      <td>정원영(화목)<br>박일근(할렐루야)<br>설진복(선교사)<br>설진일(관악풍성한)<br>황성권(구리삼락)</td>
                      <td>이승길(한빛)<br>전흥철(천안대흥)<br>맹승주(함께걷는)<br>이광현(우리동산)</td>
                    </tr>
                    <tr>
                      <td align="center">부</td>                      
                      <td>정정용(동광)<br>도용국(삼락)<br>김희송(삼락)<br>이영호(동은)</td>
                      <td>정대열(인천임마누엘)<br>권요한(삼락)</td>
                      <td>심명섭(동광)<br>김만길(삼락)<br>박의한(동아)<br>김용기(동광)<br>최철호(동광)<br>송유석(수유중앙)<br>김용삼(화목)</td>
                    </tr>
                    <tr>
                      <td align="center">장</td>                      
                      <td>윤상복(은석)</td>
                    ...
                    <tr>
                      ...
                      <td>정광수(동산)<br>김형석(동광)<br>이민우(십자가새생명)<br>권순민(부천사랑)</td>
                      <td>강복용(은석)<br>박동휘(삼일)<br>정현(동광)<br>최성일(청라은혜)</td>
                    </tr>
                    <tr>
                      <td align="center">장</td>                      
