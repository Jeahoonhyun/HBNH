...
<validator:javascript formName="userInfoFindVO" staticJavascript="false" xhtml="true" cdata="false"/>
<script type="text/javascript">
function fn_userIdFind(){
	if(validateUserInfoFindVO(document.userInfoFindVO)){        
        document.userInfoFindVO.submit();
    }
}
</script>
</head>
        ...
        <div class="content_box">
            ...
            <div class="content">
            	<div class="board_info">
                	ID를 찾기위해 회원정보를 입력하세요. (* 필수입력)</br>
                	회원가입 시 등록하신 성명, 이메일 주소, 휴대전화를 정확히 입력해 주세요. 모든 정보가 일치하면 등록하신 휴대전화로 아이디를 전송 해드립니다. 
                </div>    
            	<form name="userInfoFindVO" method="post" action="${pageContext.request.contextPath}/uss/umt/user/HbnhUserInfoFind.do">
            	<input type="hidden" name="findType" id="findType" value="MYID"/>
				<div class="board_wrap login_wrap">
                    ...
                    <div class="agree_btn" style="text-align:center; ">
                    	<input name="" type="button" value="확인" class="ipbtn01" onclick="JavaScript:fn_userIdFind(); return fallse;">                    	
                	</div>  
              	</div>              	
              	</form>
        	</div>
