...
function fn_next_step(){	
	if(!$("input:checkbox[id='joinAgree']").is(":checked")){
		alert("회원가입 약관에 동의 하시기 바랍니다.");
		return;
	}
	if(!$("input:checkbox[id='personalAgree']").is(":checked")){
		alert("개인정보처리방침에 동의 하시기 바랍니다.");
		return;
	}
	$(location).attr('href','<c:url value='/'/>uss/umt/user/EgovUserInsertView.do');
}
</script>
</head>
<body class="sub_body">
...
<div class="wrap">
    ...
    <div class="content_wrap">
        ...
        <!-- //LeftMenu 끝 -->
        	...
        	<div class="path_box">Home > 회원서비스 > 회원가입</div>
        	<h3>회원가입</h3>
            <div class="content">
            <form id="joinFrm" >
                <div class="provision_box">
               	  <div class="titl_01">함북노회 사이트 회원약관</div>
                	<div class="provision_tx">
                      <p class="pt">제1장 총 칙</p>
                      <p> 제1조(목적)</p>
                        이 약관은 함북노회의 홈페이지에서 제공하는 모든 서비스(이하 서비스라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다. 
                      <p>제2조(정의)</p> 
                        이 약관에서 사용하는 용어의 정의는 다음 각 호와 같습니다. <br>
                        1. 이용자 : 본 약관에 따라 노회가 제공하는 서비스를 받는 자<br>
                        2. 이용계약 : 서비스 이용과 관련하여 노회와 이용자간에 체결하는 계약<br>
                        3. 가입 : 노회가 제공하는 신청서 양식에 해당 정보를 기입하고, 본 약관에 동의하여 서비스 이용계약을 완료시키는 행위<br>
                        4. 회원 : 당 사이트에 회원가입에 필요한 개인정보를 제공하여 회원 등록을 한 자<br>
                        5. 이용자번호(ID) : 회원 식별과 회원의 서비스 이용을 위하여 이용자가 선정하고 노회가 승인하는 영문자와 숫자의 조합(하나의 주민등록번호에 하나의 ID만 발급 가능함)<br>
                        6. 패스워드(PASSWORD) : 회원의 정보 보호를 위해 이용자 자신이 설정한 영문자와 숫자, 특수문자의 조합<br>
                        7. 이용해지 : 노회 또는 회원이 서비스 이용이후 그 이용계약을 종료시키는 의사표시
                      <p> 제3조(약관의 효력과 변경)</p>
                        ...
                        ② 노회는 필요하다고 인정되는 경우 이 약관의 내용을 변경할 수 있으며, 변경된 약관은 서비스 화면에 공지하며, 공지후 7일 이후에도 거부의사를 표시하지 아니하고 서비스를 계속 사용할 경우 약관의 변경 사항에 동의한 것으로 간주됩니다.<br>
                      ...
                      <p class="pt">제2장 서비스 이용계약</p>
                      <p> 제5조(이용계약의 성립)</p>
                        이용계약은 이용자의 이용신청에 대한 노회의 승낙과 이용자의 약관 내용에 대한 동의로 성립됩니다.
                      <p>제6조(이용신청)</p>
                        이용신청은 서비스의 회원정보 화면에서 이용자가 노회에서 요구하는 가입신청서 양식에 개인의 신상정보를 기록하여 신청할 수 있습니다. 
                      <p>제7조(이용신청의 승낙)</p>
                        ...
                        5. 기타 노회가 정한 이용신청 요건에 미비 되었을 때 
                      <p> 제8조(계약사항의 변경)</p> <br>
                        회원은 이용신청시 기재한 사항이 변경되었을 경우에는 수정하여야 하며, 수정하지 아니하여 발생하는 문제의 책임은 회원에게 있습니다.<br>
                      
                      <p class="pt">제3장 계약당사자의 의무</p>
                      <p> 제9조(노회의 의무)</p>
                        노회는 서비스 제공과 관련해서 알고 있는 회원의 신상 정보를 본인의 승낙 없이 제3자에게 누설하거나 배포하지 않습니다. 단, 전기통신기본법 등 법률의 규정에 의해 국가기관의 요구가 있는 경우, 범죄에 대한 수사상의 목적이 있거나 또는 기타 관계법령에서 정한 절차에 의한 요청이 있을 경우에는 그러하지 아니합니다.
                      <p>제10조(회원의 의무)</p>
                        ① 회원은 서비스를 이용할 때 다음 각 호의 행위를 하지 않아야 합니다. <br>
                        1. 다른 회원의 ID를 부정하게 사용하는 행위 <br>
                        2. 서비스에서 얻은 정보를 복제, 출판 또는 제3자에게 제공하는 행위 <br>
                        3. 노회의 저작권, 제3자의 저작권 등 기타 권리를 침해하는 행위 <br>
                        4. 공공질서 및 미풍양속에 위반되는 내용을 유포하는 행위 <br>
                        5. 범죄와 결부된다고 객관적으로 판단되는 행위 <br>
                        6. 기타 관계법령에 위반되는 행위 <br>
                        ② 회원은 서비스를 이용하여 영업활동을 할 수 없으며, 영업활동에 이용하여 발생한 결과에 대하여 노회는 책임을 지지 않습니다. <br>
                        ③ 회원은 서비스의 이용권한, 기타 이용계약상 지위를 타인에게 양도하거나 증여할 수 없으며, 이를 담보로도 제공할 수 없습니다. <br>
                      
                      <p class="pt">제4장 서비스 이용 </p>
                      <p> 제11조(회원의 의무)</p>
                        ① 회원은 필요에 따라 자신의 메일, 게시판, 등록자료 등 유지보수에 대한 관리책임을 갖습니다. <br>
                        ② 회원은 노회에서 제공하는 자료를 임의로 삭제, 변경할 수 없습니다.<br>
                        ③ 회원은 노회의 홈페이지에 공공질서 및 미풍양속에 위반되는 내용물이나 제3자의 저작권 등 기타권리를 침해하는 내용물을 등록하는 행위를 하지 않아야 합니다. 만약 이와 같은 내용물을 게재하였을 때 발생하는 결과에 대한 모든 책임은 회원에게 있습니다. 
                      <p>제12조(게시물 관리 및 삭제)</p>
                        ...
                        4. 노회의 저작권, 제3자의 저작권 등 기타 권리를 침해하는 내용인 경우 <br>
                        5. 회원이 노회의 홈페이지와 게시판에 음란물을 게재하거나 음란 사이트를 링크하는 경우 <br>
                      ...
                      <p>제15조(서비스 이용 책임)</p>
                        서비스를 이용하여 해킹, 음란사이트 링크, 상용S/W 불법배포 등의 행위를 하여서는 아니되며, 이를 위반으로 인해 발생한 영업활동의 결과 및 손실, 관계기관에 의한 법적 조치 등에 관하여는 노회는 책임을 지지 않습니다. 
                      <p>제16조(서비스 제공의 중지)</p>
                      ...
                      <p class="pt"> 제5장 계약해지 및 이용제한</p>
                      <p> 제17조(계약해지 및 이용제한)</p>
                        ① 회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 인터넷을 통하여 해지신청을 하여야 하며, 노회에서는 본인 여부를 확인 후 조치합니다.<br>
                        ② 노회는 회원이 다음 각 호에 해당하는 행위를 하였을 경우 해지조치 30일전까지 그 뜻을 이용고객에게 통지하여 의견진술할 기회를 주어야 합니다.<br><br>
                        ...
                        9. 노회 또는 다른 회원이나 제3자의 지적재산권을 침해하는 경우 <br>
                      ...
                      <p class="pt"> 제6장 기 타</p>
                      <p> 제18조(양도금지)</p>
                        회원은 서비스의 이용권한, 기타 이용계약상의 지위를 타인에게 양도, 증여할 수 없으며, 이를 담보로 제공할 수 없습니다.
                      <p>제19조(손해배상)</p>
                        노회는 무료로 제공되는 서비스와 관련하여 회원에게 어떠한 손해가 발생하더라도 동 손해가 노회의 고의 또는 중대한 과실로 인한 손해를 제외하고 이에 대하여 책임을 부담하지 아니합니다.
                      <p>제20조(면책 조항)</p>
                        ① 노회는 천재지변, 전쟁 또는 기타 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스 제공에 관한 책임이 면제됩니다.<br>
                        ② 노회는 서비스용 설비의 보수, 교체, 정기점검, 공사 등 부득이한 사유로 발생한 손해에 대한 책임이 면제됩니다.<br>
                        ③ 노회는 회원의 귀책사유로 인한 서비스이용의 장애에 대하여 책임을 지지 않습니다.<br>
                        ④ 노회는 회원이 서비스를 이용하여 기대하는 이익이나 서비스를 통하여 얻는 자료로 인한 손해에 관하여 책임을 지지 않습니다.<br>
                        ⑤ 노회는 회원이 서비스에 게재한 정보, 자료, 사실의 신뢰도, 정확성 등의 내용에 관하여는 책임을 지지 않습니다.
                      <p>제21조(관할법원)</p>
                        서비스 이용으로 발생한 분쟁에 대해 소송이 제기 될 경우 노회의 소재지를 관할하는 법원을 전속 관할법원으로 합니다. 
                      <p>부 칙</p> 
                        (시행일) 이 약관은 2017년 4월 17일부터 시행합니다.<br>
                        <br>
                        <br>
                  	</div>
                  	<div class="agree_form">
                  		<input name="joinAgree" id="joinAgree" type="checkbox" value="Y">  회원가입약관의 내용에 동의합니다.
                  	</div>
                    <br>
                	<div class="titl_01">개인정보처리방침</div>
                  	<div class="provision_tx">
                  	...
                  	<div class="agree_form">
                  		<input name="personalAgree" id="personalAgree" type="checkbox" value="Y">  개인정보처리방침안내의 내용에 동의합니다.
                  	</div>

                </div>
                <div class="agree_btn">
                    <input name="" type="button" value="다음단계" class="ipbtn01" onclick="javascript:fn_next_step()">
                </div> 
                </form>         
        	</div>
        </div>                  
