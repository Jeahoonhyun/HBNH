...
<div class="main_wrap">
    ...
    <div class="main_quick">
    	<ul>
            ...
            <li><a href="#" onclick="javascript:fn_main_headPageMoveAction('904000000','문서와자료','/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_000000000019')" class="qk3"><span>일반자료</span></a></li>
    ...
    <div class="notice_box">
      <p>공지</p>
        <ul>
        	...
        	<li><a href="#" onclick="javascript:goMenuPage('906000000','커뮤니티')"><span><c:out value="${result.frstRegisterPnttm}"/></span> <c:out value="${result.nttSj}" /></a></li>        	
        	</c:forEach>          
        </ul>
    </div>
    <div class="doc_box">
    	<ul>
        	<li><a href="#" onclick="javascript:fn_main_headPageMoveAction('904000000','문서와자료','/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_000000000016')" class="dc1"><span>노회록자료</span></a></li>
            <li><a href="#" onclick="javascript:fn_main_headPageMoveAction('904000000','문서와자료','/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_000000000017')" class="dc2"><span>서식자료</span></a></li>
            <li><a href="#" onclick="javascript:fn_main_headPageMoveAction('904000000','문서와자료','/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_000000000018')" class="dc3"><span>목회자료</span></a></li>
            <li><a href="#" onclick="javascript:fn_main_headPageMoveAction('904000000','문서와자료','/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_000000000019')" class="dc4"><span>일반자료</span></a></li>
    	...
    	<ul>
        	<li><a href="#">시찰회</a>
                <ul>
	                ...
	                <li><a href="#" onclick="javascript:fn_main_headPageMoveAction('902000000','시찰회','/EgovPageLink.do?link=inspection/hbnhInspectionBucheon')">부천시찰회</a></li>
